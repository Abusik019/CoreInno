    ...
    <div className={styles.myOrders}>
      ...
      <section className={styles.lastSteps}>
        <div className={styles.lastStepsTitle}>
          ...
          <img src={questionImg} width={24} height={24} alt="question" />
        </div>
        <ul className={styles.steps}>
          <li>
            <img src={letterImg} width={46} height={46} alt="letter" />
          ...
          <li>
            <img src={phoneImg} width={46} height={46} alt="phone" />
            <div className={styles.stepInfo}>
              <h3>Выполнено</h3>
      ...
      <section className={styles.myOrdersContent}>
        ...
        <div className={styles.toAllOrders}>
          <Link to="#">
            <h2>Все заказы</h2>
            <img src={arrow} width={32} height={10} alt="arrow" />
          </Link>
        </div>
      </section>
      ...
      <section className={styles.guidesContainer}>
        <ul className={styles.guides}>
          <li>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur. At sodales sed adipiscing
              tempus est ac. Tempor elit blandittempus.
            </p>
            <button>
              <img src={whiteArrow} width={134} height={15} alt="arrow" />
            </button>
          </li>
          {mockGuides.map((guide) => (
            <li key={guide.id}>
              <div className={styles.guideTitle}>
                <h2>Название Гайда</h2>
                <button>
                  <img src={close} width={29} height={29} alt="close button" />
                </button>
              </div>
              <p>
                Lorem ipsum dolor sit amet consectetur. At sodales sed
                adipiscing tempus est ac. Tempor elit blandittempus.
              </p>
              <button>
                <img src={blackArrow} width={134} height={15} alt="arrow" />
              </button>
            </li>
          ))}
        </ul>
          ...
          <div className={styles.bigGuide}>
            <div className={styles.guideContent}>
              <div className={styles.guideTitle}>
                <h2>Название Гайда</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur. Viverra cursus quam
                  netus bibendum justo pretium est maecenas cursus.{" "}
                </p>
              </div>
              <button>
                <Link to="#">
                  <img src={arrow} width={100} height={15} alt="arrow" />
                </Link>
              </button>
            </div>
            <img
          ...
          <div className={styles.smallGuides}>
            <div>
              <div className={styles.smallGuideContent}>
                <h2>НазваниеГайда</h2>
                <p>
                  Lorem ipsum dolo. Viverra cursus quam netus bibendum justo.
                </p>
              </div>
              <img src={mockGuide} width={110} height={110} alt="guide image" />
            </div>
            <div>
              <div className={styles.smallGuideContent}>
                <h2>НазваниеГайда</h2>
