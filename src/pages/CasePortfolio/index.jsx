...
function CasePortfolio() {
  ...
  return (
    <div>
      <img onClick={() => navigate("/")} className={styles.close} src={close} alt="" />
      <div className={styles.rod}>
        ...
        <div className={styles.right}>
          ...
          <label htmlFor="upload-image">
            <img className={styles.mocKli} src={images[currentPage - 1]} alt="" style={{ cursor: "pointer" }} />
          </label>
      ...
      <footer className={styles.footer}>
        <button onClick={handlePrev} disabled={currentPage === 1}>
          <img style={{ transform: "rotate(180deg)" }} src={arrow} alt="" /> Предыдущая работа
        </button>
        <p>{currentPage} из {projects.length}</p>
        <button onClick={handleNext} disabled={currentPage === projects.length}>
